...
if __name__ == '__main__':
    ...
    for kfold_set in kfold_sets:
        ...
        chain_tester.test_trained_chain(human_chain, bot_chain, test_set)

        parameter_calculator.calculate_scoring_parameters('MarkovChain')

        data_saver.clear_result_table()
